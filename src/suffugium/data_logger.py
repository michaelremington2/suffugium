...
class DataLogger(object):
    ...
    def __init__(self, model, snake):
        self.model = model
        self.snake = snake
        self.header = ['Step', 'Agent_ID', 'Hour', 'Day', 'Month', 'Season', 'Year','Alive','Active', 'Behavior', 'Microhabitat', 'Body_Temperature', 'T_env', 'Metabolic_state','Prey_Density', 'Attack_Rate', 'Prey_Consumed', 'Cause_of_Death']
